...
import 'package:flutter_fb/bloc/common/events.dart';
import 'package:flutter_fb/bloc/common/states.dart';
import 'package:flutter_fb/models/newsfeed/index.dart';
import 'package:flutter_fb/models/notification/index.dart';
import 'package:flutter_fb/models/story/index.dart';
import 'package:flutter_fb/provider/common.dart';
import 'package:flutter_fb/provider/loader.dart';
import 'package:flutter_fb/services/api/index.dart';
    ...
    on<CommonNotificationGet>((event, emit) async {
      ...
      try {
        ...
        CommonProvider.instance
            .setNotification(NotificationModel.fromList(json['data']));
        emit(CommonSuccess());
      } catch (ex) {
        print(ex);
        emit(CommonFailure(ex.toString()));
