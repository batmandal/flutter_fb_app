...
import 'package:flutter_fb/widgets/emotion.dart';
import 'package:flutter_fb/widgets/newsfeed_card_header.dart';
import 'package:flutter_fb/widgets/newsfeed_interact_list.dart';
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              if (widget.data.contentImage != null)
